...
// Synced from command-code@1.11.1 (package.json / dist/cli.mjs package version).
const CCCLIVersion = "1.11.1"
...
// Verified against command-code@1.11.1 dist/cli.mjs (fk="command-code:device-fingerprint:v1").
...
// /alpha/fingerprint/record (recordCliFingerprint in command-code@1.11.1).
