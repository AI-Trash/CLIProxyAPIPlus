...
// Verified against command-code@0.52.5 dist/cli.mjs (var Bw="command-code:device-fingerprint:v1").
...
// attaches to /alpha/fingerprint/record (buildHeaders in command-code@0.52.5).
