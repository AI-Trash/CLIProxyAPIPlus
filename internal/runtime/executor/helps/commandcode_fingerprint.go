...
// Synced from command-code@1.51.3 (package.json HelpMessage " v" literal).
const CCCLIVersion = "1.51.3"
...
// Verified against command-code@1.51.3 dist/cli.mjs ("command-code:device-fingerprint:v1").
...
// /alpha/fingerprint/record (recordCliFingerprint in command-code@1.51.3).
