...
// Synced from command-code@1.53.0 (package.json HelpMessage " v" literal).
const CCCLIVersion = "1.53.0"
...
// Verified against command-code@1.53.0 dist/cli.mjs ("command-code:device-fingerprint:v1").
...
// /alpha/fingerprint/record (recordCliFingerprint in command-code@1.53.0).
