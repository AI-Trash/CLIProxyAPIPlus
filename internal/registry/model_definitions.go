...
func GetCommandCodeModels() []*ModelInfo {
	...
	return []*ModelInfo{
		// ── Premium models (Anthropic / OpenAI) ──
		{
			...
			ContextLength: 200000, SupportedEndpoints: []string{"/chat/completions"},
		},
		{
		...
		},
		{
			...
			ContextLength: 1000000, SupportedEndpoints: []string{"/chat/completions"},
		},
		{
		...
		},
		{
			...
			ContextLength: 128000, SupportedEndpoints: []string{"/chat/completions"},
		},
		...
		},
		{
			...
			ContextLength: 256000, SupportedEndpoints: []string{"/chat/completions"},
		},
		{
